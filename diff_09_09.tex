...
%DIF ADD rnni_geometry.tex         Thu Sep  9 11:23:17 2021
...
\DIFdel{Now consider $\fp(T', R')$ to evaluate $d(R', T')$.
	...
	\DIFadd{We now show that by the minimality assumption of $T$ and $R$, $C$ is induced by the node of rank $i$ in $R$.
	...
	There can hence not be such a cluster $D$ in $R$ and we can conclude that $C$ is induced by the node of rank $i$ in $R$.
}
