...
Discovered in the 1960s \tocite and still used today in evolutionary biology is the molecular clock hypothesis.
The idea of the molecular clock is that the evolutionary rate of a gene is more or less constant over time.
In the more recent past a relaxed version of the molecular clock is more popular \tocite, which allows rates to vary across different lineages.
Many applications, such as [..] \tocite, assume a molecular clock, as it can be used to infer dates of evolutionary events.
...
Popular tree inference methods are Maximum Likelihood \autocite{Kozlov2019-cf, Nguyen2015-sp, Tamura2011-ky} or Bayesian methods \autocite{Bouckaert2014-ir,Suchard2018-tw, Ronquist2003-eq}.
These methods rely on tree search algorithms, where in every step a new tree is proposed and accepted if the proposed tree fulfils certain requirements.
