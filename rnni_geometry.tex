...
Furthermore, subspaces of BHV-space associated with different ranked topologies have different volumes, which makes analysing distributions in this tree space difficult.
For a more detailed discussion on this we refer the reader to \autocite{Gavryushkin2016-uu}.
The same paper introduces more suitable tree spaces where internal nodes of trees are equipped with times, $t$-space and $\tau$-space.
