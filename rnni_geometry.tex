...
\todo{Using cancer evolution to demonstrate everything -- cancer trees are actual trees, not networks. The mainstream phylo community is missing this point, as everyone seems to be working on networks these days.}
...
\todo{why BHV is an inappropriate model of time trees -- a change in a recent event changes all older events, including the root date. Potentially, this can be extended and used as the main motivational framework for all results.}
