...
\todo{Do we want to keep this and if so, do we want this notation or rather a figure? -- we did not introduce this notation anywhere}
A counterexample is given by the tree $[\{a_1, a_2\}: 2, \{a_1, a_2, a_3\}:4]$ on three leaves in $dtt_4$.
