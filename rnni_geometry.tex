...
\begin{proof}
	With \autoref{thm:caterpillar_convex_rnni} we know that the set of caterpillar trees is convex.
	Let there be a path between $T$ and $R$ that is shorter than the shortest among all caterpillar paths, and consists of $r(T,R)$ $\rnni$ moves and $l(T,R)$ length moves.
