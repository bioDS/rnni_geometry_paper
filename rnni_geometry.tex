...
Discrete time-trees with root time $n-1$ are called \emph{ranked trees}, and we say ranks to mean times of nodes in ranked trees to be consistent with notations used in \autocite{Collienne2020-iu}.
...
It is also important to see that our definition of $\dtt_m$ differs from the definition in \autocite{Gavryushkin2018-ol}.
