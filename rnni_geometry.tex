...
\begin{proof}
	...
	Throughout this proof we call pairs $(i,j) \in P_T$ transpositions, as the order of leaves in the caterpillar tree $T$ can be seen as a permutation of their order in $R$. 
