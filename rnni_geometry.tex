...
\todo{Do we want to keep this as subsection? Maybe rather a separate section as this is crucial for the whole paper}
\subsection{$\findpath$ in $\dtt$}
...
This way, every move on the path $\fp(T_r,R_r)$ can be seen as a move on a path between $T$ and $R$.
