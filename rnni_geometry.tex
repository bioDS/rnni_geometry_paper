...
In order to gain knowledge about the evolutionary history in time, evolutionary trees where nodes are equipped with times are of interest in various applications, including research on cancer and virus evolution.
...
Te coalescent model is popular for reconstructing genealogical trees to infer relationships of a sample of genes \autocite{Hudson1990-ki, Kuhner2009-jb}.
...
The evolutionary history is hence derived from the time of the given samples back to its most recent common ancestor.
