...
\begin{proof}
	Let $T$ and $R$ be trees in $\dtt_m$ and $p$ a path that is shortest among all caterpillar paths between these trees, consisting of $r(T,R)$ $\rnni$ moves and $l(T,R)$ length moves.
