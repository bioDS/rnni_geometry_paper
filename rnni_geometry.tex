...
\begin{abstract}
	...
	Using a molecular clock model, times of divergence events in the evolutionary tree can be inferred.
	A class of models using this assumption are coalescent models, which are used in a variety of tree inference tools.
	In order to analyse resulting tools, especially uncertainties, some statistical measures are required.
	Therefore, a tree space for coalescent trees is necessary, as well as knowledge about its geometry.
	...
	This tree space is closely related to the ranked nearest neighbour interchange space, a tree space with properties promising for statistical analyses.
	Our tree space can be seen as discretisation of the $t$-space of time trees, and results can hence be transferred for a fine enough resolution.
\end{abstract}
