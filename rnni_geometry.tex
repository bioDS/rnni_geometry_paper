...
In this paper we consider the space $\dtt$ of discrete coalescent trees, where internal nodes are assigned distinct discrete times.
...
We will therefore investigate geometrical properties of both spaces, using the result of \autocite{Collienne2020-iu}, specifically the algorithm $\findpath$ for computing shortest paths.
