...
Rank moves between one node of $T_c$ and one node of $T_r^d$ can be interpreted as length moves, as such rank moves can be seen as length moves in the subtree $T_r^d$ (\autoref{fig:rank_move_length_move.eps}).
