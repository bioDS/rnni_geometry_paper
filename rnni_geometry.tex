...
We will refer to rank moves where one node of $T_c$ and one node of $T_d$ swap ranks as length moves.
The reason for this is that such rank moves can also be seen as length moves in the subtree $T_d$.
