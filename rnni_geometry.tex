...
\begin{abstract}
	...
	\todo{You need to talk about molecular clock here.}
	...
	\todo{You don't need to go in such detail in the firs para of Intro.
	...
	\todo{Again, too details and shortest paths come out of the blue.
...
In the following we present an algorithm with better worst-case time complexity, $\O(n \sqrt{\log n})$, for $\rnni$ (\autoref{cor:caterpillar_distance_rnni_nlogn}).
...
\begin{proof}
	...
	The number of transpositions of a sequence of length $n$ (Kendall-tau distance) can be computed in time $\O(n \sqrt{\sqrt{\log n}})$ \autocite{Chan2010-ls}.
