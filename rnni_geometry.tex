...
\todo{David (on first three paragraphs): important things in intro: (i) the idea of tree space, (ii) ranked trees and discrete coalescent trees, no need to discuss molecular clock in great detail. Mention ultrametric trees.}
...
\todo{This formula seems to be wrong. It should be: $\frac{(n-1)!n!}{2^{n-1}}{m \choose n-1}$}
...
\todo{Maybe somewhere here refer to traditional notation and why we use our notation -- it's more intuitive, especially for coding}
