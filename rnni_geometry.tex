...
\begin{proof}
	...
	For proving the lemma, we show that there is a tree caterpillar tree $T'$ in the one-neighbourhood
	\todo{define one-neighbourhood}
	 with distance $d(T',R) = d(T,R) - 1$ to $R$.
	...
	For the same reason, the parents of $a_1$ and $a_2$ also have a rank different to the parent os $a_3$ in $R$.
